...
@Component({
  selector: 'app-technicien-profile',
  templateUrl: './technicien-profile.component.html',
  styleUrls: ['./technicien-profile.component.css']
})
export class TechnicienProfileComponent implements OnInit {
